...
#    screen.blit(player, playerpos)
    ...
    # 6.2 - Draw arrows
    index=0
    for bullet in arrows:   # arrows = [[angle, valuex, valuey],[angle2, valuex2, valuey2] ]
                            # bullet = [angle, valuex, valuey]
        ...
        if bullet[1]<-64 or bullet[1]>640 or bullet[2]<-64 or bullet[2]>480:
            arrows.pop(index)
        index+=1
        for projectile in arrows:  # projectile = [angle, valuex+velx, valuey+vely]
